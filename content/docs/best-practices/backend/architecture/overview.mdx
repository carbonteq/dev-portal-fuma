...
- The tree below shows the high-level project layout (domain, application, infra, presentation, etc.).

- For details on what actually lives inside the **domain** layer (entities, value objects, errors, utilities, etc.), see the **[Domain → Overview](./domain/domain-overview)** section, which describes the 
  recommended folder and file structure for domain code.

- For details on how to organize the **infrastructure** layer (repositories,  database/config files, etc.), see the **[Infrastructure → Overview](./infrastrcture/infrastrcture-overview)** section, which 
  documents the suggested folder layout and code organization for infrastructure.
