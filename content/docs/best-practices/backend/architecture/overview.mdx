...
- For details on what actually lives inside the **domain** layer (entities, value objects, errors, utilities, etc.), see the **Domain → Overview** section, which describes the 
  recommended folder and file structure for domain code.

- For details on how to organize the **infrastructure** layer (repositories,  database/config files, etc.), see the **Infrastructure → Overview** section, which 
