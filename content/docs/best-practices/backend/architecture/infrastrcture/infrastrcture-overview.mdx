...
<Files>
  <Folder name="infra" defaultOpen>    
    ...
    <Folder name="database" defaultOpen icon={<Database />}>
      <File name="schema.ts" icon={<BiLogoTypescript />} />
      <Folder name="models" defaultOpen icon={<Table />}>
