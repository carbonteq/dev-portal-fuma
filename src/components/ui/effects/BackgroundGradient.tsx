    ...
    <div className={cn("relative p-[2px] group", containerClassName)}>
      <motion.div
        ...
        className={cn(
          ...
          "bg-[radial-gradient(circle_farthest-side_at_0_100%,#084734,transparent),radial-gradient(circle_farthest-side_at_100%_0,#0f5132,transparent),radial-gradient(circle_farthest-side_at_100%_100%,#CEF17B,transparent),radial-gradient(circle_farthest-side_at_0_0,#166534,#141316)]"
        )}
      />
      <motion.div
        variants={animate ? variants : undefined}
